...
CUSTOM_KR_THEME_MAPPING = {
    ...
    "042700": "반도체 장비·EDA", "041510": "반도체 장비·EDA", "222800": "반도체 장비·EDA", "039030": "반도체 장비·EDA", # 한미반도체, 에스엠코어 등
    
    # 2. 빅테크·플랫폼 / 인터넷·이커머스
    "035420": "빅테크·플랫폼", "035720": "빅테크·플랫폼", "066570": "빅테크·플랫폼", "402340": "빅테크·플랫폼", # 네이버, 카카오, LG전자, SK스퀘어
    ...
    # 4. 에너지·모빌리티·핀테크·우주 (2차전지, 자동차, 금융, 방산)
    "005380": "에너지·모빌리티·핀테크·우주", "000270": "에너지·모빌리티·핀테크·우주", "012330": "에너지·모빌리티·핀테크·우주", "086280": "에너지·모빌리티·핀테크·우주", # 현대차, 기아, 모비스, 글로비스
    "373220": "에너지·모빌리티·핀테크·우주", "006400": "에너지·모빌리티·핀테크·우주", "051910": "에너지·모빌리티·핀테크·우주", # LG엔솔, 삼성SDI, LG화학
    "003670": "에너지·모빌리티·핀테크·우주", "247540": "에너지·모빌리티·핀테크·우주", "096770": "에너지·모빌리티·핀테크·우주", "010950": "에너지·모빌리티·핀테크·우주", "011170": "에너지·모빌리티·핀테크·우주", # 포스코퓨처엠, 에코프로, S-Oil, 롯데케미칼
    "105560": "에너지·모빌리티·핀테크·우주", "055550": "에너지·모빌리티·핀테크·우주", "086790": "에너지·모빌리티·핀테크·우주", "316140": "에너지·모빌리티·핀테크·우주", "000030": "에너지·모빌리티·핀테크·우주", "138040": "에너지·모빌리티·핀테크·우주", # 금융지주
    "032830": "에너지·모빌리티·핀테크·우주", "000810": "에너지·모빌리티·핀테크·우주", # 삼성생명, 삼성화재
    "012450": "에너지·모빌리티·핀테크·우주", "047810": "에너지·모빌리티·핀테크·우주", "069260": "에너지·모빌리티·핀테크·우주", "079550": "에너지·모빌리티·핀테크·우주", "064350": "에너지·모빌리티·핀테크·우주", # 방산 (한화에어로, KAI, LIG넥스원, 현대로템)
    
    # 5. 헬스케어·바이오
    "207940": "헬스케어·바이오", "068270": "헬스케어·바이오", "000100": "헬스케어·바이오", "128940": "헬스케어·바이오", "196170": "헬스케어·바이오", # 삼바, 셀트리온, 유한양행, 알테오젠
    
    # 6. 필수소비·리테일
    "051900": "필수소비·리테일", "090430": "필수소비·리테일", "023530": "필수소비·리테일", "139480": "필수소비·리테일", # LG생건, 아모레, 롯데쇼핑, 이마트
    "000080": "필수소비·리테일", "004370": "필수소비·리테일", "033920": "필수소비·리테일", "097950": "필수소비·리테일", "028150": "필수소비·리테일", "271560": "필수소비·리테일", # 하이트진로, 농심, KT&G, 오리온 등
    ...
    # 8. 산업·운송·B2B서비스 (건설, 철강, 지주사, 물류, 조선)
    ...
    "010140": "산업·운송·B2B서비스", "042660": "산업·운송·B2B서비스", "329180": "산업·운송·B2B서비스", "009540": "산업·운송·B2B서비스", # 조선 4사 (HD한국조선, 한화오션 등)
    "034730": "산업·운송·B2B서비스", "003550": "산업·운송·B2B서비스", "011200": "산업·운송·B2B서비스", "003490": "산업·운송·B2B서비스", # SK, LG 지주사, HMM, 대한항공
    
    # 9. 소프트웨어·SaaS·보안
    "018260": "소프트웨어·SaaS·보안", "022100": "소프트웨어·SaaS·보안", # 삼성SDS, 포스코DX
    
    # 10. 시스템·아날로그·통신 반도체
    "009150": "시스템·아날로그·통신 반도체", "011070": "시스템·아날로그·통신 반도체", "243070": "시스템·아날로그·통신 반도체" # 삼성전기, LG이노텍 등
}

# 💡 리스트에 없는 코스피 종목을 13개 테마로 밀어넣는 초강력 징검다리 딕셔너리 (미분류 제로화)
AUTO_SECTOR_MAPPING_KR = {
    # 금융/보험 -> 에너지·모빌리티·핀테크·우주 (핀테크)
    ...
    # 전통 B2B / 운송 / 철강 / 기계 / 건설 / 화학 -> 산업·운송·B2B서비스
    ...
    "Chemicals: Major Diversified": "산업·운송·B2B서비스", "화학: 주요 다각화": "산업·운송·B2B서비스",
    
    # 전력 인프라 -> 데이터센터·전력 인프라
    "Electric Utilities": "데이터센터·전력 인프라", "전기 유틸리티": "데이터센터·전력 인프라",
    "Electrical Products": "데이터센터·전력 인프라", "전기 제품": "데이터센터·전력 인프라",
    
    # IT 부품 / 가전 -> 통신·미디어·엔터 OR 빅테크
    "Telecommunications Equipment": "통신·미디어·엔터", "통신 장비": "통신·미디어·엔터",
    ...
    "Specialty Stores": "필수소비·리테일", "전문 상점": "필수소비·리테일",
...
def render_kr_map_tab():
    ...
    if not st.session_state.kospi100_state_df.empty and len(st.session_state.kospi100_state_df) > 100:
        ...
        if px is not None:
            ...
            # 💡 삼성전자와 SK하이닉스 시총 독식 현상을 방지하기 위한 제곱근(루트) 보정 적용!
            # 숫자가 큰 종목의 면적을 부드럽게 축소하여 다른 종목들도 잘 보이게 만듭니다.
            hm_df['시가총액_보정'] = hm_df['시가총액_num'] ** 0.55 
