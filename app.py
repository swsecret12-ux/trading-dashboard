...
* **스마트 머니(세력)의 목표:** 세력이 대량 매수를 하려면 누군가 대량으로 팔아주어야 함. 따라서 개미들의 손절 물량이 쏟아지는 곳으로 가격을 밀어 유동성을 흡수(매집)한 뒤 방향을 틈."""
...
* **진짜 의미:** 차트 패턴은 그 모양 자체가 마법을 부리는 것이 아닙니다. **"사람들의 심리(공포, 탐욕, 희망, 절망)가 매수와 매도라는 행동으로 캔들에 찍히고, 그 캔들들이 모여서 특정한 모양(패턴)을 만들어낸 결과물"**입니다."""
...
def render_ai_advice_block(title, ai_text):
    ...
    # 💡 매크로/뉴스 체크 블록 최상단 배치 및 시인성 극대화 (붉은색 경고창)
